<?php
/* Smarty version 3.1.39, created on 2022-01-03 16:56:38
  from '/home/worlsxzo/public_html/ui/theme/default/leads.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_61d32ac687b5f5_76619493',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '244138832774975fed33d0f217c5a1a05a3ed712' => 
    array (
      0 => '/home/worlsxzo/public_html/ui/theme/default/leads.tpl',
      1 => 1641228986,
      2 => 'file',
    ),
  ),
...
function content_61d32ac687b5f5_76619493 (Smarty_Internal_Template $_smarty_tpl) {
...
<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_186971093561d32ac6866b81_59262761', "content");
?>


<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_44914823561d32ac6875269_74502870', "script");
?>

<?php $_smarty_tpl->inheritance->endChild($_smarty_tpl, ((string)$_smarty_tpl->tpl_vars['layouts_admin']->value));
}
/* {block "content"} */
class Block_186971093561d32ac6866b81_59262761 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'content' => 
  array (
    0 => 'Block_186971093561d32ac6866b81_59262761',
  ),
);
...
/* {/block "content"} */
/* {block "script"} */
class Block_44914823561d32ac6875269_74502870 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'script' => 
  array (
    0 => 'Block_44914823561d32ac6875269_74502870',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
...
"
            ...
            $modal.on('click', '.email_modal_submit', function(e){

                e.preventDefault();


                $.post( base_url + "leads/email/", { msg: $("#msg").val(),email: $("#lemail").val(),subject: $("#subject").val(),lid: $("#lid").val() })
                    .done(function( data ) {

                        if ($.isNumeric(data)) {

                            // window.location = base_url + 'contacts/view/' + data;
                            toastr.success('Email successfully send to '+$("#lemail").val());
                            $("#msg").val('');
                            $("#subject").val('')
            ...
            $ib_data_panel.on('click', '.emview', function(e){

                e.preventDefault();
                var lid = this.id;

                $.fancybox.open({
                    src  :  base_url + 'leads/modal_lead/email/'+lid,
                    type : 'ajax',
                    opts : {
                        afterShow : function( instance, current ) {
