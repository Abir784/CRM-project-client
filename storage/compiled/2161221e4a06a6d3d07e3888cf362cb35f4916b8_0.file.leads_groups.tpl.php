<?php
/* Smarty version 3.1.39, created on 2022-01-08 17:16:39
  from '/home/worlsxzo/public_html/ui/theme/default/leads_groups.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_61d9c6f7c7acb0_93475427',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '2161221e4a06a6d3d07e3888cf362cb35f4916b8' => 
    array (
      0 => '/home/worlsxzo/public_html/ui/theme/default/leads_groups.tpl',
      1 => 1641662190,
      2 => 'file',
    ),
  ),
...
function content_61d9c6f7c7acb0_93475427 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_loadInheritance();
$_smarty_tpl->inheritance->init($_smarty_tpl, true);
?>

<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_158133465261d9c6f7c5ecd8_15094976', "head");
?>


<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_5907137761d9c6f7c65377_84687775', "content");
?>


<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_132410656061d9c6f7c78900_22655811', "script");
?>

<?php $_smarty_tpl->inheritance->endChild($_smarty_tpl, ((string)$_smarty_tpl->tpl_vars['layouts_admin']->value));
}
/* {block "head"} */
class Block_158133465261d9c6f7c5ecd8_15094976 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'head' => 
  array (
    0 => 'Block_158133465261d9c6f7c5ecd8_15094976',
  ),
);
...
/* {/block "head"} */
/* {block "content"} */
class Block_5907137761d9c6f7c65377_84687775 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'content' => 
  array (
    0 => 'Block_5907137761d9c6f7c65377_84687775',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
                                        ...
                                        <td><strong><?php echo $_smarty_tpl->tpl_vars['g']->value['gname'];?>
                                         ...
                                         <td>
                                             <div class="btn-group float-end">
                                                 <a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
leads/find_by_group/<?php echo $_smarty_tpl->tpl_vars['g']->value['id'];?>
/" class="btn btn-sm btn-primary"> List Leads</a>
...
/* {/block "content"} */
/* {block "script"} */
class Block_132410656061d9c6f7c78900_22655811 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'script' => 
  array (
    0 => 'Block_132410656061d9c6f7c78900_22655811',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
        ...
        $(document).ready(function () {
                    ...
                    buttons: {
                        success: {
                            ...
                            callback: function () {
                                ...
                                $.post(  _url + "leads/add_group/", { group_name: group_name_val })
                                    .done(function( data ) {
            ...
            $(".cdelete").click(function (e) {
                ...
                bootbox.confirm(_L['are_you_sure'], function(result) {
                    if(result){
                        var _url = $("#_url").val();
                        window.location.href = _url + "delete/leads-group/" + id;
                    }
                });
            });
                ...
                bootbox.prompt({
                    ...
                    callback: function(result) {
                        if (result === null) {
                            ...
                            // alert(result);
                            $.post(  _url + "leads/group_edit/", { id: eid, gname: result })
                                .done(function( data ) {
                                    location.reload();
                                });
                        }
