...
{*                                        <td class="amount" data-a-sign="{if $ds['currency_symbol'] eq ''} {$config['currency_code']} {else} {$ds['currency_symbol']}{/if} ">{$ds['total']}</td>*}
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="btn-group">
                                                <a href="{$_url}purchases/view/{$ds['id']}/" class="btn btn-primary btn-sm" data-bs-toggle="tooltip" data-placement="top" title="{$_L['View']}"><i class="fal fa-file"></i></a>
                                                <a href="{$_url}purchases/clone/{$ds['id']}/" class="btn btn-success btn-sm" data-bs-toggle="tooltip" data-placement="top" title="{$_L['Clone']}"><i class="fal fa-clone"></i></a>
                                                <a href="{$_url}purchases/edit/{$ds['id']}/" class="btn btn-info btn-sm" data-bs-toggle="tooltip" data-placement="top" title="{$_L['Edit']}"><i class="fal fa-pencil"></i></a>
                                                <a href="#" class="btn btn-danger btn-sm cdelete" id="iid{$ds['id']}" data-bs-toggle="tooltip" data-placement="top" title="{$_L['Delete']}"><i class="fal fa-trash-alt"></i></a>
                                            </div>
