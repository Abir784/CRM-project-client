    ...
    <div class="panel">
        <div class="row">
            <div class="col-md-12 m-b-sm">
                ...
                <div class="panel-hdr">
                    <div class="btn-group">
                        <a href="{$_url}student/list/" class="btn btn-sm btn-danger"> {$_L['Cancel']}</a>
                        <a href="{$app_url}storage/system/student.csv" class="btn btn-sm btn-primary"><i class="fal fa-download"></i> {$_L['Download Sample File']}</a>
                    </div>
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default" id="uploading_inside">
                <div class="panel-body">
                    <form action="{$_url}student/csv_upload/" class="dropzone" id="upload_container">
