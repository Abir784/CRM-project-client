    ...
    <aside class="page-sidebar">
        ...
        <nav id="clx-primary-navigation" class="primary-nav" role="navigation">
            ...
            <ul id="clx-navigation-menu" class="nav-menu">
                ...
                {if has_access($user->roleid,'reports') || has_access($user->role,'Partner')}
                ...
                {/if}
                {if has_access($user->role,'Partner') && has_access($user->roleid,'Student')}
                    <li class="">
                        <a href="#">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <ul>
                            {if has_access($user->role,'Partner')}
                                <li>
                                    <a href="{$_url}student/add">
                ...
                {$admin_extra_nav[1]}
                        <ul>
                            {if has_access($user->roleid,'student','view') && ($config['companies'])}
                                <li>
                ...
                {if has_access($user->roleid,'partner')}
                <li class="">
                    <a href="#">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <span class="nav-link-text">{$_L['Partner']}</span>
                    </a>
                    <ul>
                        {if has_access($user->roleid,'partner','create')}
                            <li>
                                <a href="{$_url}partner/add">
                                    <span class="nav-link-text">{$_L['Add Partner']}</span>
                                </a>
                            </li>
                        {/if}

                        <li>
                            <a href="{$_url}partner/list">
                                <span class="nav-link-text">{$_L['List Partner']}</span>
                            </a>
                        </li>
                ...
                {if has_access($user->roleid,'leads','view') && ($config['leads'])}
                    ...
                    <li class="{if $selected_navigation eq 'leads'}active open{/if}">
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="{$_url}leads/"><span class="nav-link-text">{$_L['Leads']}</span></a>
                            </li>
                            <li>
                                <a href="{$_url}leads/groups">
                                    <span class="nav-link-text">{$_L['Groups']}</span>
                                </a>
                            </li>
                            <li>
                                <a href="{$_url}leads/web-to-lead/"><span class="nav-link-text">{$_L['Web to Lead']}</span></a>
                            </li>
...
{*                                <li><a href="{$_url}hrm/departments"><span class="nav-link-text">{$_L['Departments']}</span></a></li>*}
                    ...
                    {if ($config['invoicing'] eq '1') OR ($config['quotes'] eq '1')}
                        <li class="{if $selected_navigation eq 'ps'}active open{/if}">
                            ...
                            <ul>
                                ...
                                <li><a href="{$_url}ps/courses"><span class="nav-link-text">Courses</span></a></li>
                                <li><a href="{$_url}ps/c-new"><span class="nav-link-text">New Course</span></a></li>
                ...
                {if has_access($user->roleid,'course')}
                    <li class="">
                        <a href="#">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            ...
                            <span class="nav-link-text">{$_L['Course']}</span>
                        </a>
                        <ul>
                            {if has_access($user->roleid,'course','create')}
                                <li>
                                    <a href="{$_url}course/add">
                                        <span class="nav-link-text">{$_L['Add Course']}</span>
                                    </a>
                                </li>
                            {/if}
    
                            <li>
                                <a href="{$_url}course/list">
                                    <span class="nav-link-text">{$_L['List of Courses']}</span>
                                </a>
                            </li>
