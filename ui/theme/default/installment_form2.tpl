                        ...
                        <div class="px-2">
                            ...
                            <form id="rform">
                                ...
                                <div class="row">
                                    ...
                                    {for $i=0;$i<=$col;$i++}
                                        <div class="mb-3 row">
                                        <label for="name" class="col-sm-3"><span class="h6">{'Installment No.'}</span><span class="text-danger">*</span></label>
                                            <div class="col-sm-9">
                                            ...
                                            <div class="mb-3 row">
                                            <label for="code" class="col-sm-3"><span class="h6">{'Amount:'}</span></label>
                                            <div class="col-sm-9">
                                            <input type="text" id="amount" name="amount" class="form-control" value="">
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                        <label for="code" class="col-sm-3"><span class="h6">{'Due Date:'}</span></label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <button class="btn btn-primary mt-3 me-3" type="submit" id="submit">{'Add Installment'}</button>
