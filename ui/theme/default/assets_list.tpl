            ...
            <div class="card border m-lg-0 mb-3">
                ...
                <div class="card-body mb-3">
                    {if $selected_category}
                        ...
                        <a href="javascript:;" id="btnEditCategory" class="btn btn-primary">{$_L['Edit']}</a>
                        <a href="javascript:;" onclick="confirmThenGoToUrl(event,'delete/asset-category/{$selected_category->id}');" class="btn btn-danger">{$_L['Delete']}</a>
                    {else}
                ...
                bootbox.prompt({
                    ...
                    callback: function(result) {
                        if (result === null) {
                            ...
                            $.post( "{$_url}assets/category-post", { category: result, id: {$selected_category->id} }).done(function() {
                                location.reload();
                            });
                        }
                    }
