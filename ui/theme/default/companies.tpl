                                    ...
                                    <tr data-id="{$company['id']}">
                                        ...
                                        <td class="text-end">
                                            <div class="btn-group">
                                                ...
                                                <a href="{$_url}" id="ae{$company['id']}" class="btn btn-primary btn-icon cview" data-bs-toggle="tooltip" title="{$_L['View']}"><i class="fal fa-building"></i> </a>

                                                <a href="{$_url}" id="be{$company['id']}" class="btn btn-warning btn-icon cedit" data-bs-toggle="tooltip" title="{$_L['Edit']}"><i class="fal fa-pencil"></i> </a>


                                                <a href="#" class="btn btn-danger btn-icon cdelete" id="c{$company['id']}" data-bs-toggle="tooltip" title="{$_L['Delete']}"><i class="fal fa-trash-alt"></i> </a>
                                            </div>
                                        </td>
