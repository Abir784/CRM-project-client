...
<div class="container">
    ...
    <tr>
        ...
        {if $student['status']==0}
        <td><a href="#" class="block block-primary">{'Unaccepted Yet'}</a></td>
        {/if}
        {if $student['status'] !=0 && $student['payment_type'] ==0}
        <td><a href="{$_url}student/payment_update/{$student['id']}" class="btn btn-primary">{'Update Payment'}</a></td>
        {/if}
        {if $student['status'] !=0 && $student['payment_type'] !=0  }
            <td><a href="#" class="btn btn-primary">{'Full Paid'}</a></td>
        {/if}
