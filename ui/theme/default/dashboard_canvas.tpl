...
{block name="content"}
  ...
  <path d="M1 11a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1v-3zm5-4a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v7a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1V7zm5-5a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1h-2a1 1 0 0 1-1-1V2z"/>
                                    ...
                                    <div class="{if $config['leads'] && $config['companies']}col-md-4 {else} col-md-6{/if}">
                                        ...
                                        <a href="{$base_url}student/all-students/">
                                            <div class="card mb-2" style="
                                            ...
                                            {/if}
                                                ...
                                                <div class="card-body" >
                                                    <div class="row">
                                                        ...
                                                        <div class="col">
                                                            <div class="h1 text-white mb-0">{$total_students}</div>
                              ...
                              <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
                                                    ...
                                                    <p class="text-white text-hover-primary font-weight-bold font-size-lg  mt-1">{'Total Students'}</p>
                                                </div>
                        ...
                        <table class="table mb-0">
                            ...
                            {foreach $invoices as $ds}
                                <tr class="cursor-pointer clickable-row" data-id="{$ds['id']}">
                                    ...
                                    <td class="h6">{date( $config['df'], strtotime($ds['duedate']))}</td>
                                    <td class="h6">
                                        {if $ds['status'] == 'Unpaid'}
